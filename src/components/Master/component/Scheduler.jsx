...
export default class Demo extends React.PureComponent {
  constructor(props) {
    super(props);
    appointments = props.setContent.map(el => ({id: el.sche_id, title: el.use_name, startDate: moment(el.sche_start), endDate: moment(el.sche_end)}))
    orgAppointments = JSON.parse(JSON.stringify(appointments))
    this.state = {
      data: appointments,
